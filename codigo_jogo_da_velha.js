...
const perguntas_napoleao = [
    "<i>Sabendo que Napoleão Bonaparte foi a favor da Revolução Francesa e dos Jacobinos, quais foram as consequências da posição adotada por ele na revolução?</i><br><br><input onclick=\"pergunta(\'napoleao\', 0)\" name='repostas' type='radio' value='a'> Executado na guilhotina em praça pública<br><input onclick=\"pergunta(\'napoleao\', 0)\" name='repostas' type='radio' value='b'> Exilado para Inglaterra, acusado de traição à Coroa<br><input onclick=\"pergunta(\'napoleao\', 0)\" name='repostas' type='radio' value='c'> Preso em 1974 e solto posteriormente",
